const color = {
  ...
  nucleiBlue: { base: 'rgba(79, 71, 200, 1)', light: 'rgba(170, 166, 228, 1)' },
...
const typography = {
  ...
  text: {
    table: { fontSize: '1rem', fontWeight: 400, lineHeight: '1.16667rem' },
    paragraph: {
      fontSize: '1.16667rem',
      fontWeight: 400,
...
const zIndex = { nav: 1000, modal: 1100, dropdown: 1200 }
export {
  color,
  font,
  opacity,
