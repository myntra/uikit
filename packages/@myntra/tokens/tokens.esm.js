const color = {
  ...
  blue: { primary: 'rgba(79, 71, 200, 1)', regular: 'rgb(82, 142, 230)' },
  gray: {
  ...
  green: { regular: 'rgb(96, 184, 122)' },
  yellow: { regular: 'rgb(240, 186, 84)' },
  red: { regular: 'rgb(212, 106, 104)' },
  transparent: { regular: 'rgba(0, 0, 0, 0)' }
}
const font = {
  size: {
    tiny: '0.83333rem',
...
const opacity = { lighter: 0.1, light: 0.2, regular: 0.5, dark: 0.75 }
const shadow = {
...
const typography = {
  heading: {
    h1: { fontSize: '2.33333rem', fontWeight: 500, lineHeight: '2.75rem' },
    h2: { fontSize: '2rem', fontWeight: 500, lineHeight: '2.33333rem' },
    h3: { fontSize: '1.66667rem', fontWeight: 500, lineHeight: '2rem' },
    h4: { fontSize: '1.33333rem', fontWeight: 500, lineHeight: '1.75rem' }
  },
  text: {
    table: { fontSize: '1rem', fontWeight: 400, lineHeight: '1.33333rem' },
    paragraph: {
      fontSize: '1.16667rem',
      fontWeight: 400,
    ...
    title: { fontSize: '1.33333rem', fontWeight: 500, lineHeight: '1.75rem' },
    caption: {
      fontSize: '0.83333rem',
      fontWeight: 400,
...
export { color, font, opacity, shadow, shape, size, typography }
export default { color, font, opacity, shadow, shape, size, typography }
