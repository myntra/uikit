...
describe('Should render textarea tag', () => {
  ...
  it('should render textarea tag', () => {
    const wrapper = shallow(<InputTextArea onChange={handleChange} value={value} />)
...
describe('Props check', () => {
  ...
  it('should have basic properties passed as props', () => {
    ...
    expect(wrapper.find('textarea').props()).toHaveProperty('placeholder', 'Hello')
  })
  ...
  it('should have classes as defined by props', () => {
    const wrapper = shallow(<InputTextArea onChange={handleChange} value={value} disabled noResize />)
...
describe('On Change handler', () => {
  ...
  it('should call onChange handler on input change', () => {
    const wrapper = shallow(<InputTextArea onChange={handleChange} value={value} />)
    wrapper.find('textarea').simulate('change', { target: { value: 'Value Changed' } })
