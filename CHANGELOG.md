...
* fix: usability fixes ([8515101](https://bitbucket.org/myntra/uikit/commits/8515101))
...
* chore: add absolute path to docs dir ([fcdd738](https://bitbucket.org/myntra/uikit/commits/fcdd738))
* chore: Add color guidelines ([e5a3e99](https://bitbucket.org/myntra/uikit/commits/e5a3e99)), closes [#146](https://bitbucket.org/myntra/uikit/issue/146)
* chore: Add correct build sequence ([9208750](https://bitbucket.org/myntra/uikit/commits/9208750))
* chore: Add deployment setup ([f5fb91b](https://bitbucket.org/myntra/uikit/commits/f5fb91b))
* chore: Add docker startup script ([3d50a85](https://bitbucket.org/myntra/uikit/commits/3d50a85))
* chore: Add excludes file ([49cd723](https://bitbucket.org/myntra/uikit/commits/49cd723))
* chore: Add ops scripts for deployment ([7dead0a](https://bitbucket.org/myntra/uikit/commits/7dead0a))
* chore: Add parser to prettier config ([8581c1a](https://bitbucket.org/myntra/uikit/commits/8581c1a))
* chore: Add serve support ([44f99fe](https://bitbucket.org/myntra/uikit/commits/44f99fe))
* chore: Exclude node_modules ([7bcc8f4](https://bitbucket.org/myntra/uikit/commits/7bcc8f4))
* chore: Exclude node_modules ([b45890b](https://bitbucket.org/myntra/uikit/commits/b45890b))
* chore: Exlude unnecessary files ([03745ff](https://bitbucket.org/myntra/uikit/commits/03745ff))
* chore: facepalm dockins ([0f9b255](https://bitbucket.org/myntra/uikit/commits/0f9b255))
* chore: fix release script ([5593428](https://bitbucket.org/myntra/uikit/commits/5593428))
* chore: fix update versions path ([c0fcb94](https://bitbucket.org/myntra/uikit/commits/c0fcb94))
* chore: Force port ([06abd2d](https://bitbucket.org/myntra/uikit/commits/06abd2d))
* chore: Install pnpm first ([c45e613](https://bitbucket.org/myntra/uikit/commits/c45e613))
* chore: keep old code ([1f2dcae](https://bitbucket.org/myntra/uikit/commits/1f2dcae))
* chore: Launch serve with correct dir ([ae45600](https://bitbucket.org/myntra/uikit/commits/ae45600))
* chore: Move startup.sh in docker/init ([8615bfc](https://bitbucket.org/myntra/uikit/commits/8615bfc))
* chore: Refactor for package size optimisation ([2a0a3ca](https://bitbucket.org/myntra/uikit/commits/2a0a3ca))
* chore: Refactor for theme ([4a2604b](https://bitbucket.org/myntra/uikit/commits/4a2604b))
* chore: Remove compounds and elements from packages ([9ab64ce](https://bitbucket.org/myntra/uikit/commits/9ab64ce))
* chore: Remove unnecessary watched files ([50374d3](https://bitbucket.org/myntra/uikit/commits/50374d3))
* chore: Remove unused files ([0c0552f](https://bitbucket.org/myntra/uikit/commits/0c0552f))
* chore: Rewrite only known route prefixes ([dd66ac5](https://bitbucket.org/myntra/uikit/commits/dd66ac5))
* chore: Setup docs build ([77ac9b6](https://bitbucket.org/myntra/uikit/commits/77ac9b6))
* chore: sync packages ([ab824b6](https://bitbucket.org/myntra/uikit/commits/ab824b6))
* chore: trigger docs build ([63f42a8](https://bitbucket.org/myntra/uikit/commits/63f42a8))
* chore: Update dependencies ([5a30bc8](https://bitbucket.org/myntra/uikit/commits/5a30bc8))
* chore: Update lock file ([26e3651](https://bitbucket.org/myntra/uikit/commits/26e3651))
* chore: Update packages ([0f7b4aa](https://bitbucket.org/myntra/uikit/commits/0f7b4aa))
* chore: Update spectrum ([093260a](https://bitbucket.org/myntra/uikit/commits/093260a))
* chore: Use absolute path for log file ([e6518ad](https://bitbucket.org/myntra/uikit/commits/e6518ad))
* chore: Use nginx for production deployment ([fdd60b1](https://bitbucket.org/myntra/uikit/commits/fdd60b1))
* chore: Use sass instead of node-sass ([af90ba8](https://bitbucket.org/myntra/uikit/commits/af90ba8))
* chore(release): 0.7.1 ([33b7df4](https://bitbucket.org/myntra/uikit/commits/33b7df4))
* fix: Alert example ([8528473](https://bitbucket.org/myntra/uikit/commits/8528473))
* fix: NavBarItem does not have to stop event propagation ([81de450](https://bitbucket.org/myntra/uikit/commits/81de450))
* fix: Remove unused sytles ([b3e1e26](https://bitbucket.org/myntra/uikit/commits/b3e1e26))
* fix: Stub *.png files for unit tests ([b1ca958](https://bitbucket.org/myntra/uikit/commits/b1ca958))
* fix: Test cases ([db983d2](https://bitbucket.org/myntra/uikit/commits/db983d2))
* fix: Test setup ([e8c993f](https://bitbucket.org/myntra/uikit/commits/e8c993f))
* fix: TS issues ([c25f276](https://bitbucket.org/myntra/uikit/commits/c25f276))
* wip: sync input components ([cfebb8a](https://bitbucket.org/myntra/uikit/commits/cfebb8a))
* wip: Table ([c36245c](https://bitbucket.org/myntra/uikit/commits/c36245c))
* wip: table simple ([88b5a2e](https://bitbucket.org/myntra/uikit/commits/88b5a2e))
* wip: working table impl ([ca770cc](https://bitbucket.org/myntra/uikit/commits/ca770cc))
* add index file to simplify build script ([9f91e84](https://bitbucket.org/myntra/uikit/commits/9f91e84))
* add job-tracker ([8c42811](https://bitbucket.org/myntra/uikit/commits/8c42811))
* add task list ([2ab9767](https://bitbucket.org/myntra/uikit/commits/2ab9767))
* build working ([ff696ab](https://bitbucket.org/myntra/uikit/commits/ff696ab))
* feat(compounds | SchemaForm): Add optionsProvider to add options to Select fields ([18b0dc1](https://bitbucket.org/myntra/uikit/commits/18b0dc1)), closes [#119](https://bitbucket.org/myntra/uikit/issue/119)
* feat(elements | Badge): Add badge component ([1450cd1](https://bitbucket.org/myntra/uikit/commits/1450cd1)), closes [#123](https://bitbucket.org/myntra/uikit/issue/123)
* feat(elements | Tooltip): Add tooltip component ([80c5289](https://bitbucket.org/myntra/uikit/commits/80c5289)), closes [#113](https://bitbucket.org/myntra/uikit/issue/113)
* fix build script ([ed2bc10](https://bitbucket.org/myntra/uikit/commits/ed2bc10))
* Merged in feat-guidelines (pull request #158) ([966a9e3](https://bitbucket.org/myntra/uikit/commits/966a9e3)), closes [#158](https://bitbucket.org/myntra/uikit/issue/158)
* Merged in feature/input-text-area (pull request #149) ([314dae7](https://bitbucket.org/myntra/uikit/commits/314dae7)), closes [#149](https://bitbucket.org/myntra/uikit/issue/149)
* Merged in feature/inputNumber (pull request #148) ([5186945](https://bitbucket.org/myntra/uikit/commits/5186945)), closes [#148](https://bitbucket.org/myntra/uikit/issue/148)
* Merged in feature/pagination (pull request #147) ([d05fcb7](https://bitbucket.org/myntra/uikit/commits/d05fcb7)), closes [#147](https://bitbucket.org/myntra/uikit/issue/147)
* Merged in feature/s3upload (pull request #144) ([162c626](https://bitbucket.org/myntra/uikit/commits/162c626)), closes [#144](https://bitbucket.org/myntra/uikit/issue/144)
* Merged in refact/input-select (pull request #154) ([f1078e5](https://bitbucket.org/myntra/uikit/commits/f1078e5)), closes [#154](https://bitbucket.org/myntra/uikit/issue/154)
* Migrate InputDate ([91e3c06](https://bitbucket.org/myntra/uikit/commits/91e3c06))
* move components to reviewing state ([5c9e010](https://bitbucket.org/myntra/uikit/commits/5c9e010))
* remove codemods ([5806e48](https://bitbucket.org/myntra/uikit/commits/5806e48))
* remove unnecessary shuttle files ([e01f848](https://bitbucket.org/myntra/uikit/commits/e01f848))
* save ([6d1b478](https://bitbucket.org/myntra/uikit/commits/6d1b478))
* save ([f873abc](https://bitbucket.org/myntra/uikit/commits/f873abc))
* save ([4253b62](https://bitbucket.org/myntra/uikit/commits/4253b62))
* save ([84b70e6](https://bitbucket.org/myntra/uikit/commits/84b70e6))
* save ([de0ef20](https://bitbucket.org/myntra/uikit/commits/de0ef20))
* save ([939c0ce](https://bitbucket.org/myntra/uikit/commits/939c0ce))
* save ([1c702aa](https://bitbucket.org/myntra/uikit/commits/1c702aa))
* save ([9e57c74](https://bitbucket.org/myntra/uikit/commits/9e57c74))
* save ([f4e3a3a](https://bitbucket.org/myntra/uikit/commits/f4e3a3a))
* save ([5d91427](https://bitbucket.org/myntra/uikit/commits/5d91427))
* save ([c570e74](https://bitbucket.org/myntra/uikit/commits/c570e74))
* Use spectrum for docs ([d9e6da0](https://bitbucket.org/myntra/uikit/commits/d9e6da0))
* wip ([55d9743](https://bitbucket.org/myntra/uikit/commits/55d9743))
* wip ([030028c](https://bitbucket.org/myntra/uikit/commits/030028c))
* feat: Add contributing guidelines ([e3b5d97](https://bitbucket.org/myntra/uikit/commits/e3b5d97))
* feat: Add InputS3File ([a423a93](https://bitbucket.org/myntra/uikit/commits/a423a93))
* feat: Add Page component ([f74822a](https://bitbucket.org/myntra/uikit/commits/f74822a))
* feat: Add Progress component ([fdbbb2a](https://bitbucket.org/myntra/uikit/commits/fdbbb2a))
* feat: Add Simple Table ([06c0deb](https://bitbucket.org/myntra/uikit/commits/06c0deb))
* feat: Add Virtual List & Grid components ([e657ab2](https://bitbucket.org/myntra/uikit/commits/e657ab2))
* feat: Migrate  InputCheckBox component ([e9917bc](https://bitbucket.org/myntra/uikit/commits/e9917bc))
* feat: Migrate InputText component ([175161b](https://bitbucket.org/myntra/uikit/commits/175161b))
* test: Fix tests ([55e59dd](https://bitbucket.org/myntra/uikit/commits/55e59dd))
