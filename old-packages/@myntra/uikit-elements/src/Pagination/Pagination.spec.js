...
describe('Pagination', () => {
  it('displays selected page range', () => {
    const wrapper = mount(<Pagination onChange={jest.fn()} page={1} size={15} total={100} />)
  ...
  it('triggers change event on previous page', () => {
    ...
    const wrapper = mount(<Pagination onChange={handleChange} page={2} size={15} total={100} />)
  ...
  it('triggers change event on next page', () => {
    const handleChange = jest.fn()
    const wrapper = mount(<Pagination onChange={handleChange} page={1} size={15} total={100} />)
  ...
  it('does not trigger change event on next page from last page', () => {
    const handleChange = jest.fn()
    const wrapper = mount(<Pagination onChange={handleChange} page={7} size={15} total={100} />)
  ...
  it('triggers change event on page size selection', () => {
    const handleChange = jest.fn()
    const wrapper = mount(<Pagination onChange={handleChange} page={3} size={15} total={100} />)

    wrapper.find('.page-size > select').simulate('change', { target: { value: '10' } })
