...
import classnames from './s3-upload.module.scss'
import { Button, Flex, InputText as Input, Progress } from '../index'

interface S3UploadProps extends BaseProps {
    /** Auto start upload */
    autostart?: boolean,
 ...
 */
export default class S3Upload extends PureComponent<S3UploadProps> {
  constructor(props) {
    super(props)
